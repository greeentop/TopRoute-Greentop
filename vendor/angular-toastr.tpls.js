(function() {
  ...
  function toastr($animate, $injector, $document, $rootScope, $sce, toastrConfig, $q) {
    ...
    function descarregamento(message, title, optionsOverride) {
      var type = _getOptions().iconClasses.descarregamento;
      return _buildNotification(type, message, title, optionsOverride);
    }

    function selecionaGrid(message, title, optionsOverride) {
      var type = _getOptions().iconClasses.selecionaGrid;
      return _buildNotification(type, message, title, optionsOverride);
    }
  ...
  angular.module('toastr')
    .constant('toastrConfig', {
      ...
      iconClasses: {
        ...
        descarregamento: 'toast-descarregamento',
        selecionaGrid: 'toast-selecionaGrid'
      },
      maxOpened: 0,
